...
export const TASKS = [
  {
    ...
    description: "Open Orivo and review today's outlook.",
    creditsSec: 60,
    cadence: "daily",
  },
  {
    ...
    description: "Answer the personality quiz.",
    creditsSec: 300,
    cadence: "once",
  },
  {
    id: "open_numerology",
    title: "Review numerology hub",
    description: "Open Numerology hub once today.",
    creditsSec: 90,
    cadence: "daily",
  },
  {
    ...
    description: "Record one decision you've taken this week.",
    creditsSec: 180,
    cadence: "weekly",
  },
  {
    id: "share_referral",
    title: "Refer one peer",
    description: "Share your referral code with a peer founder.",
    creditsSec: 600,
    cadence: "weekly",
  },
];
