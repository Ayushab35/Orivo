...
export default function Advisor() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }} edges={["top"]}>
      ...
      >
        <View
          style={{ paddingHorizontal: 16, paddingTop: 18, paddingBottom: 10 }}
        >
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <Pressable
              ...
              style={{
                ...
                alignItems: "center",
                borderRadius: radii.pill,
                backgroundColor: view === "chat" ? c.surface : "transparent",
                borderColor: view === "chat" ? c.border : "transparent",
                borderWidth: 1,
              }}
            >
              <Text
                style={{
                  color: view === "chat" ? c.textPrimary : c.textSecondary,
                  fontSize: 12,
                  fontWeight: "600",
                }}
              >
            ...
            <Pressable
              ...
              style={{
                ...
                alignItems: "center",
                borderRadius: radii.pill,
                backgroundColor: view === "history" ? c.surface : "transparent",
                borderColor: view === "history" ? c.border : "transparent",
                borderWidth: 1,
              }}
            >
              <Text
                style={{
                  color: view === "history" ? c.textPrimary : c.textSecondary,
                  fontSize: 12,
                  fontWeight: "600",
                }}
              >
        ...
        {view === "history" ? (
          ...
          <>
                ...
                <View style={{ marginTop: 12 }}>
                  <FadeInUp index={0}>
                    ...
                    >
                      ...
                      >
                        Bring me your hardest decision today. I'll frame it
                        against your current Leadership Phase, Role-Fit, and
                        Peak Window — and end with one concrete next step.
                      </Text>
                      <Text
                        style={{
                          color: c.textMuted,
                      ...
                      >
                        Private. Conversations are saved to your account so you
                        can revisit them — never used to train any model.
                      </Text>
                    </View>
                  </FadeInUp>
                  <Text
                ...
                >
                  ...
                  <View
                    ...
                    style={{
                      maxWidth: "88%",
                      backgroundColor:
                        m.role === "user" ? c.surfaceAlt : c.surface,
                      borderColor: c.border,
                      borderWidth: 1,
                      borderRadius: radii.md,
                      paddingVertical: 12,
            ...
            >
              ...
              >
                ...
                <Pressable
                  ...
                  style={({ pressed }: any) => ({
                    ...
                    justifyContent: "center",
                    opacity:
                      input.trim() && !sending ? (pressed ? 0.85 : 1) : 0.6,
                ...
                >
                  {sending ? (
                    ...
                    <Ionicons
                      name="arrow-up"
                      size={20}
                      color={input.trim() ? c.goldInk : c.textMuted}
                    />
                  )}
                </Pressable>
              </View>
              ...
              >
                For self-reflection and decision support — not a guarantee of
                outcomes.
              </Text>
            </View>
          </>
