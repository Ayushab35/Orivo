          ...
          <>
            ...
            <FadeInUp index={1}>
              <Section title="Goal orientation">
                <Axis
                  ...
                  value={content.goalOrientation?.score ?? 50}
                  accent={c.teal}
                />
                <Text
                  style={{
                ...
                >
                  {content.goalOrientation?.detail}
                </Text>
              </Section>
            </FadeInUp>
            ...
            <FadeInUp index={2}>
              <Section title="Inner personality">
                <Text
                  style={{ color: c.textPrimary, fontSize: 14, lineHeight: 22 }}
                >
